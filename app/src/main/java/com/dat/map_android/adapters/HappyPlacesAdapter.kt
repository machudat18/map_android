package com.dat.map_android.adapters
...
import com.dat.map_android.activities.AddHappyPlaceActivity
import com.dat.map_android.activities.MainActivity
...
open class HappyPlacesAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            Glide.with(context).load(model.image).into(holder.itemView.iv_place_image)
            ...
            if(model.distance != null){
                holder.itemView.tv_distance.text = "Khoảng cách : ${model.distance} m"
            }
        }
    }
